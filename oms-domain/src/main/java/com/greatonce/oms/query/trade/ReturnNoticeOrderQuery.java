 ...
 * @version 3.0
 */
public class ReturnNoticeOrderQuery extends Query {
  /**
   * 审核时间开始.
   */
   ...
   * .
   */
  private List<String> returnNoticeOrderCodes;
  /**
   * 退换货通知单id.
   */
   ...
   * 状态.
   */
  private List<ReturnNoticeOrderStatus> statuses;
  /**
   * 版本.
   */
  ...
  /**
   * 退换货通知单编码.
   * @param returnNoticeOrderCode 退换货通知单编码
   */
  ...
  /**
   * .
   * @param returnNoticeOrderCodes 
   */
  public void setReturnNoticeOrderCodes(List<String> returnNoticeOrderCodes) {
    this.returnNoticeOrderCodes = returnNoticeOrderCodes;
  }
   ...
   * @return 
   */
  public List<String> getReturnNoticeOrderCodes() {
      return this.returnNoticeOrderCodes;
  }
   ...
   * @param statuses 状态
   */
  public void setStatuses(List<ReturnNoticeOrderStatus> statuses) {
   ...
   * @return 状态
   */
  public List<ReturnNoticeOrderStatus> getStatuses() {
