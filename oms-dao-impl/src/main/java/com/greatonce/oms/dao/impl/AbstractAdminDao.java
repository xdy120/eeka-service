 ...
 * @version 2017/5/8
 */
public abstract class AbstractAdminDao<T, Q extends Query> extends AbstractQueryDao<T, Q> {

  @Resource
  private SqlSessionDecorator adminSqlSessionDecorator;

  @Override
  protected SqlSessionDecorator getSqlSessionDecorator() {
    return adminSqlSessionDecorator;
  }
}
