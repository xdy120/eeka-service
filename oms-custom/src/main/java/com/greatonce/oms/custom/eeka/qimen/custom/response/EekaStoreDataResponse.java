...
public class EekaStoreDataResponse extends OmsQimenCustomResponse {

  public EekaStoreDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaStoreDataResponse(Long requestId,String message) {
