...
public class EekaVipReturnNoticeDataResponse extends OmsQimenCustomResponse {

  public EekaVipReturnNoticeDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaVipReturnNoticeDataResponse(Long requestId,String message) {
