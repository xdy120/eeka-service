...
public class EekaVipDeliveryDataResponse extends OmsQimenCustomResponse {

  public EekaVipDeliveryDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaVipDeliveryDataResponse(Long requestId,String message) {
