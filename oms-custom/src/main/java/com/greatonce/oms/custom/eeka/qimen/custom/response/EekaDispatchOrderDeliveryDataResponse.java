...
public class EekaDispatchOrderDeliveryDataResponse extends OmsQimenCustomResponse {

  public EekaDispatchOrderDeliveryDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaDispatchOrderDeliveryDataResponse(Long requestId,String message) {
