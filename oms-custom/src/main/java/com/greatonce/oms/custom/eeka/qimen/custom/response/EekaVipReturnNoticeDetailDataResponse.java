...
public class EekaVipReturnNoticeDetailDataResponse extends OmsQimenCustomResponse {

  public EekaVipReturnNoticeDetailDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaVipReturnNoticeDetailDataResponse(Long requestId,String message) {
