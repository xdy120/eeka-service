...
public class EekaReturnOrderDataResponse extends OmsQimenCustomResponse {

  public EekaReturnOrderDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaReturnOrderDataResponse(Long requestId,String message) {
