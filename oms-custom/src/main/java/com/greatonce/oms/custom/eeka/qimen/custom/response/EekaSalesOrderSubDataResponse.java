...
public class EekaSalesOrderSubDataResponse extends OmsQimenCustomResponse {

  public EekaSalesOrderSubDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaSalesOrderSubDataResponse(Long requestId,String message) {
