...
public class EekaDispatchOrderDetailDataResponse extends OmsQimenCustomResponse {

  public EekaDispatchOrderDetailDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaDispatchOrderDetailDataResponse(Long requestId,String message) {
