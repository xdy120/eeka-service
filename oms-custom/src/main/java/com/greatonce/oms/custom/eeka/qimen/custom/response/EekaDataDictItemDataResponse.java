...
public class EekaDataDictItemDataResponse extends OmsQimenCustomResponse {

  public EekaDataDictItemDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaDataDictItemDataResponse(Long requestId,String message) {
