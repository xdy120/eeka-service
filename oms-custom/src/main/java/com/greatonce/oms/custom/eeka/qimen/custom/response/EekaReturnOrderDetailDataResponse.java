...
public class EekaReturnOrderDetailDataResponse extends OmsQimenCustomResponse {

  public EekaReturnOrderDetailDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaReturnOrderDetailDataResponse(Long requestId,String message) {
