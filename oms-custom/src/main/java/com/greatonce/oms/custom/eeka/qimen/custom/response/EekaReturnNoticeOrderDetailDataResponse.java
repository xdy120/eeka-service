...
public class EekaReturnNoticeOrderDetailDataResponse extends OmsQimenCustomResponse {

  public EekaReturnNoticeOrderDetailDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaReturnNoticeOrderDetailDataResponse(Long requestId,String message) {
