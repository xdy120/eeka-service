...
public class EekaVipDispatchDataResponse extends OmsQimenCustomResponse {

  public EekaVipDispatchDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaVipDispatchDataResponse(Long requestId,String message) {
