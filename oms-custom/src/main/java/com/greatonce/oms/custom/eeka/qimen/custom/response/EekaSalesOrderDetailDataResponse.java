...
public class EekaSalesOrderDetailDataResponse extends OmsQimenCustomResponse {

  public EekaSalesOrderDetailDataResponse(Long requestId) {
    super(requestId);
  }

  public EekaSalesOrderDetailDataResponse(Long requestId,String message) {
